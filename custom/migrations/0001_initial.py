# Generated by Django 4.2.6 on 2023-10-10 03:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_type', models.CharField(blank=True, choices=[('Deposit', 'deposit'), ('Withdrawal', 'withdrawal')], max_length=100, null=True)),
